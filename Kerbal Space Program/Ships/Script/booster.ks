...
function Boostback {
    ...
    if RSS {
        lock SteeringVector to lookdirup(-0.5 * velocity:surface + 2*up:vector, ApproachVector).
    } else {
        lock SteeringVector to lookdirup(-0.63 * velocity:surface + up:vector, ApproachVector).
    }
