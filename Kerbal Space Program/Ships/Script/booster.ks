...
function LandingGuidance {
    ...
    if RadarRatio < 1.5*max(1,GSVec:mag/(8*Scale)) and RadarRatio > 0.13 set lateBrake to min(0.3/max(0.05,RadarRatio),2)*0.1/(Scale^1.75) * min(1,GSVec:mag/(max(0.5,RadarRatio)*6.25*Scale)) * min(1,(10*Scale)/max(1,GSVec:mag)).
