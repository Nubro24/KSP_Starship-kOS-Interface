...
- Booster/Ship krakens on contact with Chopsticks in RSS
    - **If your Booster lands beside/in front of the Tower, use [Frisk's fork](https://github.com/Frisk-33/KSP_Starship-kOS-Interface/tree/patch-1) for a potential patch (RSS only)** (hey thats this one)
